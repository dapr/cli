...
func init() {
	...
	RunCmd.Flags().StringVar(&daprdFlags, "daprd-flags", "", "Additional CLI flags passed to daprd as-is; this is an advanced option mostly for Dapr development purposes")
