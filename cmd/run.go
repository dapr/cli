...
func init() {
	...
	RunCmd.Flags().StringVarP(&componentsPath, "components-path", "", getDefaultComponentsFolder(), "Path for components directory. Default is ~/.dapr/components or %USERPROFILE%\\.dapr\\components")
