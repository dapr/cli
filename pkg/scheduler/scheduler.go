...
func ListJobs(ctx context.Context, opts ListJobsOptions) ([]*JobCount, error) {
	etcdClient, cancel, err := etcdClient(ctx, opts)
	if err != nil {
		return nil, err
	}
	defer cancel()
...
func etcdClient(ctx context.Context, opts ListJobsOptions) (*clientv3.Client, context.CancelFunc, error) {
	var etcdClient *clientv3.Client
	var err error
	if opts.KubernetesMode {
		var cancel context.CancelFunc
		etcdClient, cancel, err = etcdClientKubernetes(ctx, opts.SchedulerNamespace)
		if err != nil {
			return nil, nil, err
		}
		return etcdClient, cancel, nil
	} else {
		etcdClient, err = getEtcdClient(ctx, "localhost:2379")
		if err != nil {
			return nil, nil, err
		}
	}
...
func getEtcdClient(ctx context.Context, host string) (*clientv3.Client, error) {
...
func etcdClientKubernetes(ctx context.Context, namespace string) (*clientv3.Client, context.CancelFunc, error) {
	...
	client, err := getEtcdClient(ctx, "localhost:2379")
	if err != nil {
		return nil, nil, err
	}
